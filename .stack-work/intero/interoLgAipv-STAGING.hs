...
rrm :: Mazo -> Mazo
rrm (Mitad c (Mitad cl cll clr) (Mitad cr mrl mrr) ) =
  Mitad cl cll (Mitad c clr (Mitad cr mrl mrr))

lrm :: Mazo -> Mazo
lrm (Mitad c ml (Mitad cr crl crr)) =
  Mitad cr (Mitad c ml crl) crr
